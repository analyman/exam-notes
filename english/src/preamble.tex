...
\newcommand\tword[3]{%
\baselineskip@holder\baselineskip\baselineskip=0pt%
\index{#1}%
\if@intword\relax\else\global\@intwordtrue\relax\tword@begin\fi%
#1&#2&#3%
...
\index{#1}%
\if@intword\relax\else\global\@intwordtrue\relax\tword@begin\fi%
\omit\vbox{\vskip.5ex\hbox{\quad\vrule width4.3pt\qquad\vbox{\parindent=0pt\hsize=.8\hsize\baselineskip=15pt%
...
\def\tword@stop@@{\cr\egroup\@ifnextchar\vskip{}{\smallskip}\global\@intwordfalse\baselineskip\baselineskip@holder}
\long\def\tword@begin{%
    \halign to\hsize\bgroup%
    \strut{\tt\color{red}##} \quad&%
...
\newcommand{\word}[3]{\index{##1}\hbox{{\tt\color{red}##1}\hskip1em{\color{blue}\tt\textipa{[##2]}}\hskip1em{\lishu\color{black}##3}}\@ifnextchar\vskip{}{\par}}
