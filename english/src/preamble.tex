...
\newcommand{\word}[3]{\hbox{{\color{red}##1}\hskip1em{\color{blue}\textipa{[##2]}}\hskip1em{\color{black}##3}}\newline}
\newcommand{\dword}[1]{{\color{red}##1\hskip.5em\relax}}
\newcommand{\phrase}[2]{\hbox{{\color{red}##1}\hskip1em\hskip1em{\color{black}##2}}\newline}
\def\crr{\cr\hline}
\smallskip%
...
\smallskip
\begin{longtable}{|
    >{\global\advance\vocCount\@ne\bgroup\englishstyle\hskip1em}p{0.22\hsize}<{\egroup} | %
    >{\bgroup\english@phonetic@style\textipa\bgroup\quad[}p{0.22\hsize}<{]\hfil\egroup\egroup} | %
    >{\bgroup\attstyle}p{0.1\hsize}<{\egroup} | %
    >{\bgroup\chinesestyle}p{0.25\hsize}<{\egroup} |}
    \hline
}{%
\hline
\end{longtable}
